...
class ChatManager extends Manager_1.default {
    constructor(options) {
        ...
        this.io.on('connection', (socket) => {
            socket.on(SEND_MESSAGE, (token, message, roomId) => __awaiter(this, void 0, void 0, function* () { return yield this.sendMessage(socket, token, message, roomId); }));
            socket.on(JOIN_ROOM, (token, roomId) => __awaiter(this, void 0, void 0, function* () { return yield this.joinRoom(socket, token, roomId); }));
        });
    }
    getRoom(roomId) {
        return this.rooms.get(roomId);
    }
    joinRoom(socket, token, roomId) {
    ...
    sendMessage(socket, token, message, roomId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (token && message) {
                const user = this.mediator.get(this.TRIGGERS.GET_USER, socket.id);
                if (user && user.verification(token)) {
