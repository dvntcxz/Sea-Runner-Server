...
class DB {
    constructor(options) {
        ...
        (() => __awaiter(this, void 0, void 0, function* () {
            /*const user = await this.allMessagesThisUser(2);
            console.log(user);*/
        }))();
    ...
    addMessage(data) {
        const { userIdFrom, userIdTo, message } = data;
        this.db.run('INSERT INTO users(userIdFrom,userIdTo,message) VALUES(?,?,?)', [userIdFrom, userIdTo, message]);
    }
}
exports.default = DB;
