...
class DB {
    ...
    getUserByLogin(login) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.orm.select('users').where({ login }).run();
        });
    }
    addUser(data) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    addMessage(roomId, userIdFrom, message) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.orm.insert('messages', [{ roomId, userIdFrom, message }]).run();
        });
    }
