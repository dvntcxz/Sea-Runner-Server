...
const Town_1 = __importDefault(require("./Entite/Town"));
...
class Game {
    constructor(db, mediator) {
        ...
        this.mediator.subscribe(this.EVENTS.INIT_DATABASE, () => __awaiter(this, void 0, void 0, function* () { return yield this.init(); }));
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.loadTowns();
    ...
    loadTowns() {
        return __awaiter(this, void 0, void 0, function* () {
            for (let i = 1; i < 4; i++) {
                const town = new Town_1.default(this.db);
                yield town.init(i);
